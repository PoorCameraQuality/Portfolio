      ...
      <div className="container relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="text-xl text-[#2c786c] font-semibold">Premium Quality Feed</span>
          </div>
          ...
          <div className="text-sm text-[#2c786c]">
            Want a site like this for your shop? <a href="https://cheaplocalwebsites.com" target="_blank" rel="noopener" className="text-[#f8b400] underline">Get yours for $15/mo</a>.
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16 lg:mt-20">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2 text-[#004445]">Fast Delivery</h3>
            <p className="text-[#2c786c]">Same-day delivery available for local orders</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2 text-[#004445]">Quality Assured</h3>
            <p className="text-[#2c786c]">Premium products from trusted manufacturers</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2 text-[#004445]">Expert Support</h3>
            <p className="text-[#2c786c]">Professional advice for all your farming needs</p>
          </div>
        </div>
