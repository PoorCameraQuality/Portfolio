          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                className="card bg-surface/80 backdrop-blur-sm hover:scale-105 transition-transform duration-300"
              >
      ...
      <section className="py-20 bg-surface/50">
        <div className="container">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="card bg-surface/80 backdrop-blur-sm border-2 border-brand/20">
