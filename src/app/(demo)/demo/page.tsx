      ...
      <section className="section bg-bg">
        <div className="container">
          <div className="text-center mb-16">
            <h1 className="h1 text-text-primary mb-6">Demo One-Pagers</h1>
            <p className="lead text-text-primary/80 max-w-2xl mx-auto">
              Free single-page demos for local businesses. See how your shop could look online for just <strong>$15/mo</strong>.
            </p>
            <div className="mt-6">
              <a
            ...
            {onepagers.map((onepager) => (
              <div key={onepager.slug} className="card group hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  ...
                  <Link href={`/demo/${onepager.slug}`} className="link inline-flex items-center group" aria-label={`View ${onepager.title} demo`}>
                    View Demo
          ...
          <div className="text-center mt-16">
            <div className="card max-w-2xl mx-auto">
              ...
              <p className="text-text-primary/80 mb-6">
                These are free demo one-pagers. For a custom domain, up to 5 pages, full SEO and ongoing support,
                upgrade to the Starter Website Package (<strong>$50 setup + $15/month</strong>).
              </p>
              <div className="mt-6">
