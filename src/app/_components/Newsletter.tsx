    ...
    <section className="section">
      <div className="container">
        <div className="card p-8 md:p-10 text-center">
          ...
          <h3 className="h2 text-3xl mb-3">Tips for local websites (monthly)</h3>
          ...
          <form className="flex flex-col sm:flex-row gap-3 justify-center max-w-xl mx-auto">
            <input type="email" required placeholder="Email address" className="px-4 py-3 rounded-lg w-full" style={{ border: '1px solid var(--border)' }} />
